...
const AccountDetails = () => {
    ...
    useEffect(() => {
        ...
        // console.log(Object.values(accountData))
    }, [])
    ...
    return (
        <div className='w-full'>
            <div className='w-[90%] md:w-[70%] mx-auto mt-[100px] md:mt-[150px] mb-[180px]'>
                ...
                {/* heading */}
                <div className='w-full flex justify-center poppins items-center pb-10 relative'>
                    <h1 className=' text-[28px] font-[700]'>ACCOUNT DETAILS</h1>
                </div>
                ...
                <>
                    {
                        Object.values(accountData) === "" ?
                            ...
                            <div className="w-full">
                                <div className="w-[70%] mx-auto gap-5 hidden md:flex">

                                    {/* skeleton body */}
                                    <div className=' flex flex-col w-[70%] justify-center items-center mb-[5px] relative overflow-hidden bg-[#dfdddd]'>
                                    ...
                                    {/* skeleton body */}
                                    <div className=' flex flex-col w-[30%] justify-center items-center mb-[5px] relative overflow-hidden bg-[#dfdddd]'>
                                        <div className='w-full min-h-[400px]'>
                                            {/* Skeleton loader*/}
                                            <div className={`absolute left-0 top-0 bottom-0 bg-gradient-to-r from-[#dfdddd] via-[#ecebebc9] to-[#dfdddd] w-full skeleton-animation `}></div>
                                        </div>
                                ...
                                <div className="w-[90%] mx-auto gap-5 flex flex-col md:hidden">

                                    {/* skeleton body */}
                                    <div className=' flex flex-col w-full justify-center items-center mb-[5px] relative overflow-hidden bg-[#dfdddd]'>
                                        <div className='w-full min-h-[400px]'>
                                            {/* Skeleton loader*/}
                                            <div className={`absolute left-0 top-0 bottom-0 bg-gradient-to-r from-[#dfdddd] via-[#ecebebc9] to-[#dfdddd] w-full skeleton-animation `}></div>
                                        </div>
